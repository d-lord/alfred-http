statuses = [
  {
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.2.1",
  },
  {
    :status_code => "101",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.2.2",
  },
  {
    :status_code => "200",
    :reason_phrase => "OK",
    :one_liner => "Standard response for successful HTTP requests",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.1",
  },
  {
    :status_code => "201",
    :reason_phrase => "Created",
    :one_liner => "The request has been fulfilled and resulted in a new resource being created",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.2",
  },
  {
    :status_code => "202",
    :reason_phrase => "Accepted",
    :one_liner => "The request has been accepted for processing, but the processing has not been completed" ,
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.3",
  },
  {
    :status_code => "203",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.4",
  },
  {
    :status_code => "204",
    :reason_phrase => "No Content",
    :one_liner => "The server successfully processed the request, but is not returning any content" ,
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.5",
  },
  {
    :status_code => "205",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.6",
  },
  {
    :status_code => "206",
  ...
  },
  {
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7232#section-4.1",
  },
  {
    :status_code => "305",
  ...
  },
  {
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.6",
  },
  {
    :status_code => "407",
    :reason_phrase => "Proxy Authentication Required",
    :one_liner => "The client must first authenticate itself with the proxy",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7235#section-3.2",
  },
  {
    :status_code => "408",
    :reason_phrase => "Request Timeout",
    :one_liner => "The server timed out waiting for the request",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.7",
  },
  {
    :status_code => "409",
  ...
  },
  {
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.9",
  },
  {
    :status_code => "411",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.10",
  },
  {
    :status_code => "412",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7232#section-4.2",
  },
  {
    :status_code => "413",
    :reason_phrase => "Payload Too Large",
    :one_liner => "The request is larger than the server is willing or able to process",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.11",
  },
  {
    :status_code => "414",
    :reason_phrase => "URI Too Long",
    :one_liner => "The URI provided was too long for the server to process",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.12",
  },
  {
    :status_code => "415",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.13",
  },
  {
    :status_code => "416",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7233#section-4.4",
  },
  {
    :status_code => "417",
    :reason_phrase => "Expectation Failed",
    :one_liner => "The server cannot meet the requirements of the Expect request-header field",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.14",
  },
  {
    :status_code => "426",
    :reason_phrase => "Upgrade Required",
    :one_liner => "The client should switch to a different protocol",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.15",
  },
  {
    :status_code => "429",
  ...
  },
  {
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.1",
  },
  {
    :status_code => "501",
    :reason_phrase => "Not Implemented",
    :one_liner => "The server does not support the functionality required to fulfill the request",
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.2",
  },
  {
    :status_code => "502",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.3",
  },
  {
    :status_code => "503",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.4",
  },
  {
    :status_code => "504",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.5",
  },
  {
    :status_code => "505",
    ...
    :defined_in => "https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.6",
  },
